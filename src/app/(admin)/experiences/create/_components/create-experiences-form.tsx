...
type WorkFormData = z.infer<typeof createWorkSchema>

export default function ExperiencesForm({ defaultValues }: Props) {
  ...
  const onSubmit: SubmitHandler<
    Omit<Extract<WorkFormData, { mode: 'create' }>, 'mode'>
  > = async (data) => {
    let response
    ...
    response = await createExperiences({ ...transformedData })
  ...
  return (
    <div className={cn('flex flex-col p-10 ')}>
      <Form {...form}>
        <form
