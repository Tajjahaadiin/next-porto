...
const ExperiencesCard = (experience: SelectWorkModel) => {
  return (
    <div
      className={cn(
      ...
      <div className="flex px-5 gap-10">
        ...
        <div className="flex justify-between w-full ">
          <div className="flex flex-col space-y-5">
            <div className="">
              <p className="text-xl font-bold">{experience.workPosition}</p>
              <p className="text-green-500">{experience.workPlace}</p>
            </div>
            <div className="space-y-5">
              <div className="">
                <ul className="list-disc px-5">
                  {experience.workDescription.map((data, index) => (
                    <li key={index}>{data}</li>
                  ))}
                </ul>
              </div>
              <div className="flex gap-4 text-gray-600">
                {experience.workTech.map((tech, index) => (
                  <span
